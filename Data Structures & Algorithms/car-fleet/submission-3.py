class Solution:
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        # TC: O(nlogn)! because of the sorting, python runs Timsort: mergesort with an opportunistic frontend - worst case is nlogn
        # SC: output space: O(m) m is the length of stack; during: O(n), n is num of cars
